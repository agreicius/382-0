...
},
{
  ...
  "number": "1.16.4",
  "title": "Generalized Cauchy integral formula.",
  "body": " Generalized Cauchy integral formula   Compute where is the closed simple polygonal path that traverses the square in the clockwise direction.       "
},
{
  "id": "th_morera",
  "level": "2",
...
},
{
  ...
  "body": " Differentiating power series   Let , where is a positive integer. Find a power series representation of centered at that converges on .    The idea is to relate with . Note that , , and more generally (using an easy induction argument) for all . Thus we have . Now, beginning with the power series representation and using (3) of , we see that . We conclude that , where we use the binomial coefficient notation . Note that since the original power series for converges for all , each successive formal derivative of this power series also converges for all .   "
},
{
  ...
  "body": " Power series for   Find a power series expansion of that converges on .    Let . Since is holomorphic on , we know from the proof of that we can define an antiderivative of on via the formula , where is the straight line parametrization. Using (2) of , we then have , and that this power series converges for all . Note that the last step in the chain of equalities above follows from the fact that is an antiderivative of , and thus . Lastly, since and are both antiderivatives of on (check this for yourself for ), we have for some . Evaluating at , we see that since , we must have . We conclude that for all .   "
},
{
  "id": "d_analytic",
  "level": "2",
...
},
{
  ...
  "body": " Analytic implies holomorphic   Let be a complex function.   If is analytic at a point , then is holomorphic at . Using logical shorthand:     If is analytic at with power series representation , then , where is the counterclockwise oriented boundary of any closed disk containing .      "
},
{
