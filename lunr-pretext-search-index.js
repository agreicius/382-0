...
},
{
  ...
  "type": "Remark",
  "number": "1.1.11",
  "title": "<span class=\"process-math\">\\(i\\)<\/span> as square-root of <span class=\"process-math\">\\(-1\\)<\/span>.",
  "body": " as square-root of  It follows from our work in that : , is a square-root of . This observation gives rise to a more motivated understanding of the complex number system . Roughly speaking, we can think of as the smallest number system containing and a square-root of that we call . (I say roughly here as I haven't really told you what I mean by a number system, or by the smallest number system.) Furthermore, we can think of the definition of complex multiplication given by as forced upon us, assuming that satisfies and multiplication is associative and commutative.  "
},
{
  "id": "th_mult_inv",
  "level": "2",
  ...
  "body": " Multiplicative inverses   Let be a nonzero complex number: , or (or both). The complex number satisfies .   "
},
{
  "id": "d_mult_inv",
  "level": "2",
...
},
{
  ...
  "body": " Inverses and quotients   Compute the following complex numbers. Your answer must be expressed in the form , where .    , where                , where and      , where and           "
},
{
  "id": "d_integer_powers",
  "level": "2",
