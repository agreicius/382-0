...
},
{
  "id": "th_limit_point",
  "level": "2",
  "url": "s_analyticity.html#th_limit_point",
  "type": "Theorem",
  "number": "1.18.4",
  "title": "Limit point.",
  "body": " Limit point   Let be open and connected, and assume is holomorphic on . Let be the set of zeros of on . If has an limit point, then for all .       "
},
{
  "id": "cor_limit_points",
  "level": "2",
  "url": "s_analyticity.html#cor_limit_points",
  "type": "Corollary",
  "number": "1.18.5",
  "title": "Rigidity.",
  "body": " Rigidity   Let be open and connected, and let and be holomorphic functions on . If the set has a limit point, then for all .   "
},
{
